                    ...
                    items.value.push(
                        {
                            ...
                            command: () => {
                                ...
                                titleDialog.value = `${element.workflow_status.name} Settlement`;
                                messageDialog.value = `Are you sure you want to do the next action:${element.workflow_status.description}`;
                                ...
                                toast.add({ severity: 'success', summary: 'Updated', detail: 'Settlement marked', life: 3000 });
                            },
                        }
                    )
                }

...
<template>
    ...
    <div class="card">
        ...
        <Table v-if="ability.can('tipo_producto_listado')" title="" path-api="/unit_types" @HeaderNames="onHeaderNames" @onRowSelect="RowSelect" :dataGot="dataFromComponent" :allLabels="allLabels" />

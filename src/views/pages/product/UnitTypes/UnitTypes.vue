...
const { getAllResponseAPI, postResponseAPI, putResponseAPI, deleteResponseAPI, dataResponseAPI } = useDataAPI();
...
<template>
    ...
    <div class="card">
        <Toolbar style="margin-bottom: 1rem">
            <template #center>
                <Button v-if="ability.can('unidad_medida_crear')" :disabled="headerNames.length > 0" label="New" icon="pi pi-plus" class="p-button-success mb-2 mt-2" @click="openNew" size="large" />
                <Divider v-if="ability.can('unidad_medida_crear')" layout="vertical" />
                <Button v-if="ability.can('unidad_medida_editar')" :disabled="!(listRowSelect.length > 0 && listRowSelect.length < 2)" label="Edit" icon="pi pi-file-edit" class="p-button-help mb-2 mt-2" @click="openEdit" size="large" />
                <Divider v-if="ability.can('unidad_medida_editar')" layout="vertical" />
        ...
        <Table v-if="ability.can('unidad_medida_listado')" title="" path-api="/unit_types" @HeaderNames="onHeaderNames" @onRowSelect="RowSelect" :dataGot="dataFromComponent" :allLabels="allLabels" />

...
<template>
    <div class="surface-0 flex justify-content-center min-h-screen" style="background: linear-gradient(180deg, var(--paleta-400) 5%, var(--paleta-100) 15%)">
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            >
                ...
                <div class="flex justify-content-end sm:flex-order-2 lg:col-4">
                    <img src="/demo/images/landing/screen-basil.png" alt="Hero Image" class="w-12" />
                </div>
            </div>

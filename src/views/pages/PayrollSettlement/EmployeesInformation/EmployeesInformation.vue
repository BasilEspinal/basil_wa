...
const formDialogExportTitle = 'Exportar Información de Empleados';
const formDialogDeleteTitle = 'Eliminar Registros';
const formDialogExport = ref(false);
const formDialogDelete = ref(false);
const { itemsActions } = useActions('/transactions/transEmployee');
...
const openDialog = (mode, rowData) => {
    state.value = mode;
    formDialogTitle.value = mode === 'new' ? 'Nueva Información de Empleado' : mode === 'edit' ? 'Editar Información' : mode === 'clone' ? 'Clonar Información' : '';
        ...
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">Información de Empleados</h1>
                        <p class="m-0 text-600 font-medium mt-1">Resumen y detalles de transacciones por empleado</p>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div class="grid">
            ...
            <Toolbar style="margin-bottom: 1rem">
                <template #center>
                    ...
                    <Button v-if = "ability.can('trabajo_contratista_editar')" :disabled="!(listRowSelect.length > 0 && listRowSelect.length < 2)" label="Edit" icon="pi pi-file-edit" class="p-button-help mb-2 mt-2" @click="openEdit" size="large" />
                    <Divider v-if = "ability.can('trabajo_contratista_editar')" layout="vertical" />
                    <Button v-if = "ability.can('trabajo_contratista_crear')" :disabled="!(listRowSelect.length > 0 && listRowSelect.length < 2)" label="Clone" icon="pi pi-copy" class="p-button-secondary mb-2 mt-2" @click="openClone" size="large" />
                    <Divider v-if = "ability.can('trabajo_contratista_crear')" layout="vertical" />

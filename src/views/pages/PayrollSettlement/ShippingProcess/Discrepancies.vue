...
const { itemsActions } = useActions('/transactions/shipment/discrepancies');
                    ...
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        <div class="flex gap-2 align-items-center">
                            ...
                            <span class="p-input-icon-left">
                                ...
                                <InputText v-model="filters['global'].value" placeholder="Buscar discrepancia..." class="w-full md:w-20rem" />
                            </span>
                        </div>
                ...
                <Column header="Acciones" :frozen="true" alignFrozen="right" style="min-width: 12rem">
                    <template #body="{ data }">
                        <div class="flex gap-2">
                            ...
                            <Button icon="pi pi-check-circle" class="p-button-rounded p-button-text p-button-success" @click="openDialog('patch', data)" v-tooltip.top="'Validar'" />

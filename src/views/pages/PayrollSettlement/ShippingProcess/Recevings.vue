...
const { itemsActions } = useActions('/transactions/receiving/receivings');
                    ...
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        <div class="flex gap-2 align-items-center">
                            ...
                            <span class="p-input-icon-left">
                                ...
                                <InputText v-model="filters['global'].value" placeholder="Buscar recepción..." class="w-full md:w-20rem" />
                            </span>
                        </div>

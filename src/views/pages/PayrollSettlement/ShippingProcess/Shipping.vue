<template>
    ...
    <div class="card">
        ...
        <Column field="transactionDate" filterField="transaction_date" header="Transaction Date" sortable>
    <template #body="{ data }">
...
<Column field="voyageNumber" filterField="voyage_num" header="Voyage Number" sortable>
    <template #body="{ data }">
        {{ data.voyage_num }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by voyage number" />
    </template>
</Column>

<Column field="vehicleQtyMax" filterField="vehicle_qty_max" header="Vehicle Quantity Max" sortable>
    <template #body="{ data }">
        {{ data.vehicle_qty_max }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by vehicle qty max" />
    </template>
</Column>

<Column field="sentQty" filterField="sent_qty" header="Sent Quantity" sortable>
    <template #body="{ data }">
        {{ data.sent_qty }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by sent quantity" />
    </template>
</Column>

<Column field="dispatchNumberLot" filterField="dispatch_number_lot" header="Dispatch Number Lot" sortable>
    <template #body="{ data }">
        {{ data.dispatch_number_lot }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by dispatch number" />
    </template>
</Column>

<Column field="notes" filterField="notes_small" header="Notes" sortable>
    <template #body="{ data }">
        {{ data.notes_small }}
    </template>
    <template #filter="{ filterModel }">
...
<Column field="plannerTasksCodes" header="Planner Task Crop Lot Codes" sortable>
    <template #body="{ data }">
        {{ data.planner_tasks.crop_lots.map(crop => crop.code).join(', ') }}
    </template>
</Column>

<Column field="tasksOfType" filterField="tasks_of_type.name" header="Task Type" sortable>
    <template #body="{ data }">
...
<Column field="supervisorName" header="Supervisor Name" sortable>
    <template #body="{ data }">
        {{ data.supervisory.first_name }} {{ data.supervisory.lasts_names }}
    </template>
</Column>

<Column field="employeeName" header="Employee Name" sortable>
    <template #body="{ data }">
        {{ data.employee.first_name }} {{ data.employee.lasts_names }}
    </template>
</Column>

<Column field="vehicleCode" filterField="vehicle.code" header="Vehicle Code" sortable>
    <template #body="{ data }">
        {{ data.vehicle.code }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by vehicle code" />
    </template>
</Column>

<Column field="productName" filterField="product.name" header="Product Name" sortable>
    <template #body="{ data }">
        {{ data.product.name }}
    </template>
    <template #filter="{ filterModel }">
...
<Column field="productTypeName" filterField="product_type.name" header="Product Type Name" sortable>
    <template #body="{ data }">
        {{ data.product_type.name }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by product type" />
    </template>
</Column>

<Column field="packingTypeCode" filterField="packing_type.code" header="Packing Type Code" sortable>
    <template #body="{ data }">
        {{ data.packing_type.code }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by packing type code" />
    </template>
</Column>

<Column field="varietyName" filterField="varieties.name" header="Variety Name" sortable>
    <template #body="{ data }">
        {{ data.varieties.name }}
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by variety name" />
    </template>
</Column>

<Column field="shippingStatus" filterField="shipping_statuses.name" header="Shipping Status" sortable>
    <template #body="{ data }">
        <Tag :value="data.shipping_statuses.name" :severity="'info'" />
    </template>
    <template #filter="{ filterModel }">
        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by shipping status" />
    </template>
</Column>
...
const namePage = t('appmovil.envios');

...
const formDialogExportTitle = 'Exportar Periodos de Pago';
const formDialogDeleteTitle = 'Eliminar Registros';
const formDialogExport = ref(false);
const formDialogDelete = ref(false);
const { itemsActions } = useActions('/transactions/transcodepayperiod');
...
const initFilters = () => {
    filters.value = {
        ...
        'planner_tasks.crop_lots': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
        ...
        'worker_employee.last_name_b': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
        'worker_employee.bank_account_number': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
        code_pays_period: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
        ...
        packing_type: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
        ...
        'tasks_statuses.name': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
...
const openDialog = (mode, rowData) => {
    state.value = mode;
    formDialogTitle.value = mode === 'new' ? 'Nuevo Periodo de Pago' : mode === 'edit' ? 'Editar Periodo' : mode === 'clone' ? 'Clonar Periodo' : '';
    ...
    <div>
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">Periodos de Pago</h1>
                        <p class="m-0 text-600 font-medium mt-1">Información detallada de periodos y códigos de pago</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
                    ...
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        <div class="flex gap-2 align-items-center">
                            ...
                            <span class="p-input-icon-left">
                                ...
                                <InputText v-model="filters['global'].value" placeholder="Buscar periodo..." class="w-full md:w-20rem" />
                            </span>
                        </div>
            ...
            <template #header>
                ...
                <Column field="planner_tasks.crop_lots" filterField="planner_tasks.crop_lots" header="Crop Lots" sortable>
                    <template #body="{ data }">
                        {{ data.planner_tasks.crop_lots }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Crop Lots" />
                    </template>
                </Column>

                <Column field="tasks_of_type.name" filterField="tasks_of_type.name" header="Task Type" sortable>
                    <template #body="{ data }">
                        {{ data.tasks_of_type.name }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Task Type" />
                    </template>
                </Column>
                ...
                <Column field="worker_employee.last_name_b" filterField="worker_employee.last_name_b" header="Second Last Name" sortable>
                    <template #body="{ data }">
                        {{ data.worker_employee.last_name_b }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Second Last Name" />
                    </template>
                </Column>

                <Column field="worker_employee.bank_account_number" filterField="worker_employee.bank_account_number" header="Bank Account Number" sortable>
                    <template #body="{ data }">
                        {{ data.worker_employee.bank_account_number }}
                    </template>
                    <template #filter="{ filterModel }">
                ...
                <Column field="code_pays_period" filterField="code_pays_period" header="Code Pays Period" sortable>
                    <template #body="{ data }">
                        {{ data.code_pays_period }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Code Pays Period" />
                    </template>
                </Column>
                ...
                <Column field="packing_type" filterField="packing_type" header="Packing Type" sortable>
                    <template #body="{ data }">
                        {{ data.packing_type }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Packing Type" />
                    </template>
                </Column>
                ...
                <Column field="tasks_statuses.name" filterField="tasks_statuses.name" header="Task Status" sortable>
                    <template #body="{ data }">
                        {{ data.tasks_statuses.name }}
                    </template>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="text" class="p-column-filter" placeholder="Search by Task Status" />
                    </template>
                </Column>

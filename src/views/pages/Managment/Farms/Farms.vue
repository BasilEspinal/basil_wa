...
const { getItems, itemsActions, messageDialog, titleDialog, status_id_Action, flagDialog } = useActions(`/processflow/Farm`);
import ability from '@/service/ability.js';

const { t } = useI18n();

const dynamicColumns = [
    { field: 'name', header: 'Farm Name', frozen: true, color: false },
    { field: 'code', header: 'Farm Code', frozen: false, color: false },
...
/**
 * Fetches farm records from the API using CrudService.
 */
...
const openDialog = (mode, rowData) => {
    ...
    if (mode === 'new') {
        ...
        resetForm();
        const { code, company: empresa, name: nombre } = source;
        ...
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">{{ $t('menu.farms') }}</h1>
                        <p class="m-0 text-600 font-medium mt-1">Gestión integral de fincas y activos</p>
                    </div>
                </div>
            ...
            >
                <template #header>
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        ...
                        <div class="flex gap-2">
                            <Button icon="pi pi-plus" class="p-button-raised p-button-success p-button-rounded" @click="openDialog('new')" v-tooltip.top="'Nueva Sede'" />

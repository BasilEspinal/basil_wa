<template>
    <div class="grid">
        <div class="card col-12 lg:col-12 xl:col-12">
            <h3>Planeación Diaria para el Area : {{ areawork }}</h3>
        </div>
    </div>
    <div class="grid">
        <div class="card col-12 lg:col-6 xl:col-6">
            <div>
        ...
        <div class="card col-12 lg:col-6 xl:col-6">
            <div>
                <h3>Empleado : {{ data_planner.name_employee }}</h3>
                <div class="p-fluid formgrid grid">


                    <div class="field col-12 md:col-6">
                        <pre>Precio : {{ data_planner.day_price }}</pre>
                    </div>
                    <div class="field col-12 md:col-6">
                        <pre>Cant.Acumulada :{{ data_planner.total_packing }}</pre>
                    </div>
                    <div class="field col-12 md:col-6">
                        <pre>Total Estimado : {{ data_planner.day_price * data_planner.total_packing }}</pre>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="p-fluid formgrid grid">
                        <div class="field col-12 md:col-6">
                            ...
                            <Dropdown v-model="select_tasks_type" :options="task_type" filter optionLabel="name"
                                placeholder="Select Task" class="w-full md:w-20rem" />
                        </div>
                        <div class="field col-12 md:col-6">
                            <label for="cropslots">Lote</label>
                            <Dropdown v-model="selected_crops_lots" :options="crops_lots" filter optionLabel="name"
                                placeholder="Select Lots" class="w-full md:w-20rem" />
                        </div>
                        <div v-if="select_tasks_type.name !== 'Task'" class="field col-12 md:col-6">
                            ...
                            <Dropdown v-model="selected_dones_work" :options="dones_work" filter optionLabel="name"
                                placeholder="Select Labor" class="w-full md:w-20rem" />
                        </div>
                        <div class="field col-12 md:col-6">
                        ...
                        <div class="field col-12 md:col-3">
                            ...
                            <p>
                                <label for="peso">{{ data_planner.day_price }}</label>
                            </p>
                        </div>
                        <div class="field col-12 md:col-3">

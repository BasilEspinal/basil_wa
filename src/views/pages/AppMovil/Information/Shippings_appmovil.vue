        ...
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">{{ $t('appmovil.shipping.shippingProcess') }}</h1>
                        <p class="m-0 text-600 font-medium mt-1">Gestión de procesos de envío</p>
                    </div>
                </div>
            </div>
        </div>

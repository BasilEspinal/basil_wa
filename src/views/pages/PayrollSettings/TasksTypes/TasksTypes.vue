        ...
        <div class="grid">
            ...
            <Dialog v-model:visible="formDialog" :style="{ width: '700px' }" header="Unit Types Details" :modal="true"
                ...
                <div class="formgrid grid">
                    ...
                    <div v-for="key in conditionsTasksTypes " :key="key" class="field">
...
import useRestrictionTasksTypes from '@/composables/PayrollSettings/TasksTypes/restrictionTasksTypes';
...
const allLabels = ref([])
const { conditionsTasksTypes } = useRestrictionTasksTypes();
allLabels.value = Object.values(conditionsTasksTypes).map(condition => condition.fieldName);
let endpoint = ref("/tasks_of_type")

...
/**
 * Opens the form dialog for creating or viewing calendar record details.
 * @param {string} mode - The mode in which to open the form ('new', 'details', etc.).
 * @param {Object} [rowData] - Optional calendar record.
 */
const openForm = (mode, rowData) => {
    ...
    formProperties.value = {
        open: true,
        title: mode === 'Ver Detalles' || mode === 'details' ? 'Detalles de Calendario' : 'Formulario',
        mode: mode,
...
/**
 * Fetches calendar records from the API using CrudService.
 */
...
const openDialog = (mode, rowData) => {
    ...
    if (mode === 'new') {
        ...
        resetForm();
        const { code, company: empresa, farm: farmParameter, name: nombre, type_date: type, transaction_date: date } = source;
...
/**
 * Handles batch patching of status for selected calendar records.
 */
        ...
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">{{ $t('menu.calendars') }}</h1>
                        <p class="m-0 text-600 font-medium mt-1">Gestión de días laborables y festivos</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        <div class="flex gap-2 align-items-center">
                            ...
                            <span class="p-input-icon-left">
                                ...
                                <InputText v-model="filters['global'].value" placeholder="Buscar fecha..." class="w-full md:w-20rem" />
                            </span>
                        </div>

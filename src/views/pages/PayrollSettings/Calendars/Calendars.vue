<template>
    ...
    <div class="card">
        <div>
            <h1>Información de Calendarios Colombia</h1> 
        </div>
    </div>
    <div class="card">
        <div class="grid">
        ...
        <Column field="transaction_date" filterField="transaction_date" header="Date Transaction" sortable frozen=""> <!--Replace :frozen with the model-->
            <template #header>

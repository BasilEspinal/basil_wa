...
const dynamicColumns = [
    ...
    { field: 'start_date', header: 'Start Date', frozen: false, color: false },
    { field: 'end_date', header: 'End Date', frozen: false, color: false },
    { field: 'period_num', header: 'Period Number', frozen: false, color: false },
    { field: 'quantity_days', header: 'Quantity Days', frozen: false, color: false },
    ...
    // { field: 'status.color', header: 'Status Color', frozen: false, color: true },
...
const openForm = (mode, rowData) => {
    ...
    formProperties.value = {
        open: true,
        title: mode === 'Ver Detalles' || mode === 'details' ? 'Detalles de Periodo de Pago' : 'Formulario',
        mode: mode,
        ...
        cardSections.value = [
            {
                ...
                fields: {
                    ...
                    'Period Number': row.period_num,
                    'Quantity Days': row.quantity_days,
...
const openDialog = (mode, rowData) => {
    ...
    if (mode === 'new') {
        ...
        resetForm();
        const { period_num: periodNum, company: empresa, farm: farmParameter, start_date: startDate, end_date: endDate } = source;
        
        start_dateV.value = new Date(startDate);
        end_dateV.value = new Date(endDate);
        if (periodNum && periodNumber.value.data) {
             const periodObj = periodNumber.value.data.find((p) => p.id === periodNum);
             if (periodObj) periodNumberV.value = { id: periodNum, name: periodObj.name };
        }
        ...
        <div class="card mb-4 bg-primary-reverse border-round-xl shadow-2">
            <div class="flex align-items-center justify-content-between p-3">
                <div class="flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="m-0 text-3xl font-bold tracking-tight">{{ $t('menu.payPeriods') }}</h1>
                        <p class="m-0 text-600 font-medium mt-1">Configuración de periodos de corte para nómina</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
                ...
                <template #header>
                    <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                        ...
                        <div class="flex gap-2">
                            <Button icon="pi pi-plus" class="p-button-raised p-button-success p-button-rounded" @click="openDialog('new')" v-tooltip.top="'Nuevo Periodo'" />
            ...
            <Dialog v-model:visible="formDialog" modal :header="formDialogTitle" class="p-fluid text-center mx-auto">
                <div class="mb-3">
                    ...
                    <FrontEndErrors :errorsNew="errorsNew" name="start_dateV" />
                ...
                <div class="mb-3">
                    ...
                    <FrontEndErrors :errorsNew="errorsNew" name="end_dateV" />
                ...
                <div class="mb-3">
                    ...
                    <FrontEndErrors :errorsNew="errorsNew" name="periodNumberV" />

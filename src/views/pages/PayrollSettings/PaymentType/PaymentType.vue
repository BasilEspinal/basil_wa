<template>
    <h1>Información tipos de pago  Nómina  </h1>
  <div class="card">
      <div class="grid">
          ...
          <Dialog v-model:visible="formDialog" :style="{ width: '700px' }" header="Unit Types Details" :modal="true"
              ...
              <div class="formgrid grid">
                  ...
                  <div v-for="key in conditionsPaymentTypes " :key="key" class="field">
...
import useRestrictionPaymentTypes from '@/composables/PayrollSettings/PaymentType/restrictionPaymentTypes';
...
const allLabels = ref([])
const { conditionsPaymentTypes } = useRestrictionPaymentTypes();
allLabels.value = Object.values(conditionsPaymentTypes).map(condition => condition.fieldName);
let endpoint = ref("/payment_types")

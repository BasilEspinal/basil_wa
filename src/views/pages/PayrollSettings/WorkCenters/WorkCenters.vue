<template>
    ...
    <div class="card">
        <div>
            <h1>Información de centros de trabajo</h1> 
        </div>
    ...
    <div class="card">
        ...
        <Dialog v-model:visible="formDialogNew" modal :header="'Create new workcenter'" class="p-fluid text-center mx-auto">
                <div class="mb-3">
            ...
            <Dialog v-model:visible="formDialogEdit" modal :header="'Edit workcenter'" class="p-fluid text-center mx-auto">
                <div class="mb-3">
                    <div class="flex align-items-center gap-3 mb-1">
                        <label for="username" class="font-semibold w-6rem">Name :</label>
                        <InputText id="username" v-model="name" class="flex-auto" autocomplete="off" v-bind="nameProps" />
            ...
            <Dialog v-model:visible="formDialogClone" modal :header="'Clone workcenter'" class="p-fluid text-center mx-auto">
                <div class="mb-3">
                    <div class="flex align-items-center gap-3 mb-1">
                        <label for="username" class="font-semibold w-6rem">Name :</label>
                        <InputText id="username" v-model="name" class="flex-auto" autocomplete="off" v-bind="nameProps" />

<template>
    ...
    <div class="card">
        ...
        <Column field="taskType" filterField="taskType.name" header="Task Type" sortable :frozen="documentFrozen"> <!--Replace :frozen with the model-->
            <template #header>
        ...
        <Column field="type_date" filterField="type_date" header="Date Type " sortable> 
        ...
        <Column field="type_price" filterField="type_price" header="Price Type" sortable> 

        ...
        <div class="grid">
            ...
            <Dialog v-model:visible="formDialog" :style="{ width: '700px' }" header="Unit Types Details" :modal="true"
                ...
                <div class="formgrid grid">
                    ...
                    <div v-for="key in conditionsTasksTarifs " :key="key" class="field">
...
import useRestrictionTasksTarifs from '@/composables/PayrollSettings/TasksTarif/restrictionTasksTarif.js';
...
const allLabels = ref([])
const { conditionsTasksTarifs } = useRestrictionTasksTarifs();
allLabels.value = Object.values(conditionsTasksTarifs).map(condition => condition.fieldName);
